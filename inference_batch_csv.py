...
if (len(sys.argv) != 3):
        print("e.g. python inference_batch_csv.py hot_cores test_data/data.csv")
        sys.exit(0)
...
if model_name == 'hot_cores':
        ...
        models_array = [
         ...
         ,(3,'llda_models/model_alma_band_6_3_500it/','llda_train_input/alma_band_6_3_features.dat','llda_train_input/alma_band_6_3_labelmap.sub')
         ,(4,'llda_models/model_alma_band_6_4_500it/','llda_train_input/alma_band_6_4_features.dat','llda_train_input/alma_band_6_4_labelmap.sub')
         ...
         ,(5,'llda_models/model_alma_band_6_full_expanded_00120_x3_500it','llda_train_input/alma_band_6_full_expanded_00120_x3_features.dat','llda_train_input/alma_band_6_full_labelmap.sub')
         ,(5,'llda_models/model_alma_band_6_full_expanded_00200_x3_500it','llda_train_input/alma_band_6_full_expanded_00200_x3_features.dat','llda_train_input/alma_band_6_full_labelmap.sub')
        ]
        ...
        ,(5,'llda_models/model_agb_ppn_pn_full_expanded_00200_x3_500it','llda_train_input/agb_ppn_pn_full_expanded_00200_x3_features.dat','llda_train_input/agb_ppn_pn_full_labelmap.sub')
        ...
        ,(5,'llda_models/model_planetary_full_expanded_00200_x3_500it','llda_train_input/planetary_full_expanded_00200_x3_features.dat','llda_train_input/planetary_full_labelmap.sub')
        ...
        ,(5,'llda_models/model_dark_clouds_full_expanded_00200_x3_500it','llda_train_input/dark_clouds_full_expanded_00200_x3_features.dat','llda_train_input/dark_clouds_full_labelmap.sub')
        ...
        ,(5,'llda_models/model_diffuse_clouds_full_expanded_00200_x3_500it','llda_train_input/diffuse_clouds_full_expanded_00200_x3_features.dat','llda_train_input/diffuse_clouds_full_labelmap.sub')
        ...
        ,(5,'llda_models/model_comets_full_expanded_00200_x3_500it','llda_train_input/comets_full_expanded_00200_x3_features.dat','llda_train_input/comets_full_labelmap.sub')
        ...
        ,(5,'llda_models/model_extragalactic_full_expanded_00200_x3_500it','llda_train_input/extragalactic_full_expanded_00200_x3_features.dat','llda_train_input/extragalactic_full_labelmap.sub')
        ...
        for channeling, model_path, features_path, labelmap_path in models_array:
                with open(mData) as f:
                        for test_example in f:
                                ...
                                spectral_window_option = test_example.split(';')[1]
                                species_no = test_example.split(';')[2]
                                
                                os.system("python inference_csv.py "+model_path+" "+features_path+" "+labelmap_path+" "+str(channeling)+" "+fits_path+" "+spectral_window_option+" "+species_no)
                                fits_name = fits_path.split('/')[-1].split('.')[0]
                                fits_name = fits_name+"."+spectral_window_option.replace(",","-")

                                model = model_path.split('/')[1]
                                out_name = fits_name+"."+model+".output"
                                os.system("mv output_csv.dat results."+model_name+".t"+run+"/"+out_name)
        os.system("mv matches_csv.out results."+model_name+".t"+run+"/matches.out")
