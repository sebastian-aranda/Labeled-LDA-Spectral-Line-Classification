...
# python inference_batch.py diffuse_clouds test_data/data_test.diffuse_clouds.csv
# python inference_batch.py comets test_data/data_test.comets.csv
# python inference_batch.py extragalactic test_data/data_test.extragalactic.csv
# python inference_batch.py planetary test_data/data_test.planetary.csv
