...
python train_auto.py llda_train_input/comets_tr.dat.gz 1.6 0.003 30 500 model_comets_tr_500it
python train_auto.py llda_train_input/comets_2.dat.gz 1.6 0.0004 30 500 model_comets_2_500it
python train_auto.py llda_train_input/comets_full.dat.gz 1.6 0.0003 30 500 model_comets_full_500it
