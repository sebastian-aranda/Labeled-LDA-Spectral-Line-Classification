...
#python train_auto.py llda_train_input/dark_clouds_full.dat.gz 0.9 0.0002 58 500 model_dark_clouds_full_500it
#python train_auto.py llda_train_input/dark_clouds_full_expanded_3-0.001.dat.gz 0.9 0.0003 58 500 model_dark_clouds_full_expanded_3-0.001_500it
...
#python train_auto.py llda_train_input/diffuse_clouds_full_expanded_3-0.001.dat.gz 2.1 0.0001 24 500 model_diffuse_clouds_full_expanded_3-0.001_500it
...
#python train_auto.py llda_train_input/comets_full_expanded_3-0.001.dat.gz 1.7 0.0001 30 500 model_comets_full_expanded_3-0.001_500it
...
#python train_auto.py llda_train_input/extragalactic_full_expanded_3-0.001.dat.gz 1.4 0.0001 36 500 model_extragalactic_full_expanded_3-0.001_500it
