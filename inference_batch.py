...
if model_name == 'hot_cores':
        ...
        models_array = [(0,'llda_models/model_planetary_tr_500it/','llda_train_input/planetary_tr_labelmap.sub'),(2,'llda_models/model_planetary_2_500it/','llda_train_input/planetary_2_labelmap.sub'),(5,'llda_models/model_planetary_full_500it/','llda_train_input/planetary_full_labelmap.sub'), (5,'llda_models/model_planetary_full_expanded_500it','llda_train_input/planetary_full_labelmap.sub')]
elif model_name == 'dark_clouds':
        models_array = [(0,'llda_models/model_dark_clouds_tr_500it/','llda_train_input/dark_clouds_tr_labelmap.sub'),(2,'llda_models/model_dark_clouds_2_500it/','llda_train_input/dark_clouds_2_labelmap.sub'),(5,'llda_models/model_dark_clouds_full_500it/','llda_train_input/dark_clouds_full_labelmap.sub'),(5,'llda_models/model_dark_clouds_full_expanded_500it','llda_train_input/dark_clouds_full_labelmap.sub')]
elif model_name == 'diffuse_clouds':
        models_array = [(0,'llda_models/model_diffuse_clouds_tr_500it/','llda_train_input/diffuse_clouds_tr_labelmap.sub'),(2,'llda_models/model_diffuse_clouds_2_500it/','llda_train_input/diffuse_clouds_2_labelmap.sub'),(5,'llda_models/model_diffuse_clouds_full_500it/','llda_train_input/diffuse_clouds_full_labelmap.sub'),(5,'llda_models/model_diffuse_clouds_full_expanded_500it','llda_train_input/diffuse_clouds_full_labelmap.sub')]
elif model_name == 'comets':
        models_array = [(0,'llda_models/model_comets_tr_500it/','llda_train_input/comets_tr_labelmap.sub'),(2,'llda_models/model_comets_2_500it/','llda_train_input/comets_2_labelmap.sub'),(5,'llda_models/model_comets_full_500it/','llda_train_input/comets_full_labelmap.sub'),(5,'llda_models/model_comets_full_expanded_500it','llda_train_input/comets_full_labelmap.sub')]
elif model_name == 'extragalactic':
        models_array = [(0,'llda_models/model_extragalactic_tr_500it/','llda_train_input/extragalactic_tr_labelmap.sub'),(2,'llda_models/model_extragalactic_2_500it/','llda_train_input/extragalactic_2_labelmap.sub'),(5,'llda_models/model_extragalactic_full_500it/','llda_train_input/extragalactic_full_labelmap.sub'),(5,'llda_models/model_extragalactic_full_expanded_500it','llda_train_input/extragalactic_full_labelmap.sub')]
else:
...
for channeling, model_path, labelmap_path in models_array:
        with open(mData) as f:
                for test_example in f:
                        ...
                        #print(fits_path)
                        os.system("python inference.py "+model_path+" "+labelmap_path+" "+str(channeling)+" "+fits_path+" "+species_no)
