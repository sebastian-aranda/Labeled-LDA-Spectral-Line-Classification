...
# python ./scripts/frequency_expander.py alma_band_7_full.dat 3 0.01000
# mv alma_band_7_full_expanded.dat ./llda_train_input/alma_band_7_full_expanded_01000_x3.dat
# rm alma_band_7_full.dat
# python ./scripts/get_vocabulary.py ./llda_train_input/alma_band_7_full_expanded_01000_x3.dat > ./llda_train_input/alma_band_7_full_expanded_01000_x3_features.dat
