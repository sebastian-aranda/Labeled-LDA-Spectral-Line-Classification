...
if len(sys.argv) != 4:
	print("e.g. python llda_input_parser_CASA.fix1.py casa_spectrum/spectrum.dat 2 244.93555")
	sys.exit(0)
...
channeled_freq_list = [int(round(freq*10**channeling)) for freq in freq_list] #fix1
