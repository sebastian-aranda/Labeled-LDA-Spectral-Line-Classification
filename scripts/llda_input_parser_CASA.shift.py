...
if len(sys.argv) != 4:
	print("e.g. python llda_input_parser_CASA.py casa_spectrum/spectrum.dat 2 244.93555")
...
#Channeling
channeled_freq_list = [int(math.floor(freq*10**channeling)) for freq in shifted_freq_list]
